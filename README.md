...
3. Under the latest release, find the Windows installer or executable file. This will typically end with `.exe`.
...
7. When the install finishes, launch the application from your desktop or start menu.

---

## 🖥️ Running webxr-dev-skill

1. Once the app loads, you will see a simple menu with options and examples.

2. Connect your Meta Quest headset to your PC using a Link cable or enable Air Link.

3. Ensure your headset is set to allow developer mode. You can enable this in the Meta Quest mobile app under device settings.

4. The app will detect your headset and show a "Connected" status.

5. Start with the first example project provided in the app.

6. Follow the on-screen instructions to run the VR scene inside your headset.

7. Use your Meta Quest controllers to interact with the VR environment.
